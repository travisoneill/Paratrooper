...
function helicopterLeft(ctx, x, y) {
  ...
  ctx.fillStyle(x, y+16, 2, 2);
  ctx.fillStyle(x+10, y+16, 2, 2);
  ctx.fillStyle(x+20, y+16, 2, 2);
  ctx.fillStyle(x+2, y+18, 30, 2);
}
...
function helicopterRight() {
  ...
  ctx.fillStyle = '#00ffff';
  ctx.fillStyle(x+26, y+16, 2, 2);
  ctx.fillStyle(x+36, y+16, 2, 2);
  ctx.fillStyle(x+46, y+16, 2, 2);
  ctx.fillStyle(x+16, y+18, 30, 2);
}
